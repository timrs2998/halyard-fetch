 ...
 * Rather than pull in a full DOM implementation for a handful of timer and
 * crypto calls, point `window` at the Node global object — `setTimeout`,
 * `setInterval`, their clear-counterparts and `crypto` all live there already,
